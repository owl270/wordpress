...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'proshop_bd3dac399a0d36171498_20231015103859_archive.zip';
        const ARCHIVE_SIZE       = '112633855';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'bd3dac3-15103859';
        const SECONDARY_PACKAGE_HASH = '525e527-15103859';
        const VERSION            = '1.5.6';
